...
- ea.m: computes Gaussian affinities based on an adaptive bandwidth for each
  data point given a global perplexity value.
- x2p.m: like ea.m but slower and less accurate.
  (Code originally from Sam Roweis.)
