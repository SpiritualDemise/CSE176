% [G,E] = mlpsgd(X,Y,Xv,Yv,l,eta,maxit,B,g0,I)
% Train sigmoidal MLP y = f(x) = V.s(W.x+w)+v with stochastic gradient descent
%
% In:
...
function [G,E] = mlpsgd(X,Y,Xv,Yv,l,eta,maxit,B,g0,I)
...
for i=2:length(G)
  [g,~,e] = mlptrain(X,Y,g,l,eta,B,0,I);		% SGD step & train.err.
